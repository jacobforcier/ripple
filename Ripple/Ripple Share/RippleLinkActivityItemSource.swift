...
//
//  Why a String and not a URL? When a Share Extension presents another
//  UIActivityViewController and hands a `URL` object to Messages, the URL
//  arrives at Messages as a bplist-encoded blob — NSItemProvider doesn't
//  unwrap across the extension boundary cleanly. A String is safe: Messages
//  auto-detects URLs in text and renders them as proper bubbles with
//  previews; Mail, Notes, Slack, and other targets also handle a URL-in-
//  string cleanly.
//
